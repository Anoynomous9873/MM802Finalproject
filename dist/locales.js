...
shaka.ui.Locales.addTo = function(localization) {
  localization.insert('ar', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] من [NUM_ADS:6]'],
    ['AD_TIME', 'الإعلان: [AD_TIME:0:05/0:10]'],
    ['AUTO_QUALITY', 'تلقائي'],
    ['BACK', 'رجوع'],
  ...
  localization.insert('de', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] von [NUM_ADS:6]'],
    ['AD_TIME', 'Werbeanzeige: [AD_TIME:0:05/0:10]'],
  ...
  localization.insert('en-GB', new Map([
    ['AD_DURATION', 'Ad duration'],
    ['AD_PROGRESS', '[AD_ON:1] of [NUM_ADS:6]'],
    ['AD_TIME', 'Ad: [AD_TIME:0:05/0:10]'],
    ['AUTO_QUALITY', 'Auto'],
    ['BACK', 'Back'],
    ['CAPTIONS', 'Captions'],
    ['CAST', 'Cast...'],
  ...
  localization.insert('es', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] de [NUM_ADS:6]'],
    ['AD_TIME', 'Anuncio: [AD_TIME:0:05/0:10]'],
  ...
  localization.insert('fr', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] sur [NUM_ADS:6]'],
    ['AD_TIME', 'Annonce : [AD_TIME:0:05/0:10]'],
  ...
  localization.insert('it', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] di [NUM_ADS:6]'],
    ['AD_TIME', 'Annuncio: [AD_TIME:0:05/0:10]'],
  ...
  localization.insert('ja', new Map([
    ['AD_DURATION', '広告再生時間'],
    ['AD_PROGRESS', '[AD_ON:1] 番目 / 全 [NUM_ADS:6] 個'],
    ['AD_TIME', '広告: [AD_TIME:0:05/0:10]'],
    ['AUTO_QUALITY', '自動'],
    ['BACK', '戻る'],
    ['CAPTIONS', '字幕'],
    ['CAST', 'キャスト...'],
  ...
  localization.insert('ko', new Map([
    ['AD_DURATION', '광고 기간'],
    ['AD_PROGRESS', '[AD_ON:1]/[NUM_ADS:6]'],
    ['AD_TIME', '광고: [AD_TIME:0:05/0:10]'],
    ['AUTO_QUALITY', '자동'],
    ['BACK', '뒤로'],
    ['CAPTIONS', '자막'],
    ['CAST', '전송...'],
  ...
  localization.insert('nl', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] van [NUM_ADS:6]'],
    ['AD_TIME', 'Advertentie: [AD_TIME:0:05/0:10]'],
    ['AUTO_QUALITY', 'Automatisch'],
    ['BACK', 'Terug'],
  ...
  localization.insert('pl', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] z [NUM_ADS:6]'],
    ['AD_TIME', 'Reklama: [AD_TIME:0:05/0:10]'],
  ...
  localization.insert('pt-BR', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] de [NUM_ADS:6]'],
    ['AD_TIME', 'Anúncio: [AD_TIME:0:05/0:10]'],
  ...
  localization.insert('ru', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] из [NUM_ADS:6]'],
    ['AD_TIME', 'Объявление: [AD_TIME:0:05/0:10]'],
    ['AUTO_QUALITY', 'Авто'],
    ['BACK', 'Назад'],
    ['CAPTIONS', 'Титры'],
    ['CAST', 'Транслировать...'],
  ...
  localization.insert('th', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1] จาก [NUM_ADS:6]'],
    ['AD_TIME', 'โฆษณา: [AD_TIME:0:05/0:10]'],
  ...
  localization.insert('tr', new Map([
    ...
    ['AD_PROGRESS', '[AD_ON:1]/[NUM_ADS:6]'],
    ['AD_TIME', 'Reklam: [AD_TIME:0:05/0:10]'],
